// UX-001 — BrandedSelect
// Spec source: reports/audit-ux-2026-06-11-0824-slscrm.vercel.app.md UX-001.magic_prompt (item 2)
// Adapted: NO Radix dep allowed — native <select> with custom-styled trigger via
// background-image chevron, CSS appearance:none. Loses radio-style checkmark in menu
// (browser-rendered menu), accepted tradeoff for zero-deps.
...
export default function BrandedSelect({
  ...
  return (
    <div>
      {label && (
        <label htmlFor={selectId} className="block text-fs-2 font-medium text-[var(--ink)]">
          {label}
        </label>
      )}
