// UX-005 — BentoMetric + BentoGrid
// Spec source: reports/audit-ux-2026-06-11-0824-slscrm.vercel.app.md UX-005.magic_prompt
// Single file ships both. tone: neutral|solar|leaf. live=true adds pulsing dot before eyebrow.
// `theme: 'light' | 'dark'` added so hero / stakes (ink bg) can reuse the same card on dark surface.
