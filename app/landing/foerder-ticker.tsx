export default function FoerderTicker() {
  ...
  return (
    <section className="border-y border-[var(--line)] bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-5 text-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono-data text-[11px] uppercase tracking-wider text-[var(--muted)]">
            Förder-Status live
          </span>
        </div>
        <div className="flex flex-wrap items-baseline gap-x-8 gap-y-2 font-mono-data text-[13px] text-[var(--ink)]">
          <span>
